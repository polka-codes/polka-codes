...
import { z } from 'zod'
import { type AgentToolResponse, type FullToolInfo, ToolResponseType } from '../'
...
const createMockTool = (name: string, description: string, handler: (args: any) => Promise<AgentToolResponse>): FullToolInfo => ({
  name,
  description,
  parameters: z.object({
