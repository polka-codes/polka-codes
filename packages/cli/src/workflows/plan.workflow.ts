...
import type { ToolHandler, WorkflowFnV2 } from '@polka-codes/workflow'
import { z } from 'zod'
...
export const planWorkflow: WorkflowFnV2<PlanWorkflowInput, PlanWorkflowOutput, CliToolRegistry> = async (
  input,
  { toolHandler, logger },
) => {
