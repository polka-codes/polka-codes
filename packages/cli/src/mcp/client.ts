...
/**
 * Zod schema for validating MCP tool call results
 */
...
export class McpClient implements IMcpClient {
  ...
  async callTool(name: string, args: Record<string, unknown>): Promise<McpToolResult> {
    ...
    try {
      ...
      const validationResult = McpToolResultSchema.safeParse(response)
      if (!validationResult.success) {
        throw new McpToolError(this.serverName, name, `Invalid response structure from tool call: ${validationResult.error.message}`)
      }
