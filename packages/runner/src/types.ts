...
import type { ToolParameterValue } from '@polka-codes/core'
import { z } from 'zod'

const toolParameterValueSchema: z.ZodType<ToolParameterValue> = z.lazy(() =>
  z.union([
    z.string(),
    z.number(),
    z.boolean(),
    z.null(),
    z.record(z.string(), toolParameterValueSchema),
    z.array(toolParameterValueSchema),
  ]),
)
  ...
  z.object({
    ...
    requests: z.array(
      z.object({
        index: z.number(),
        tool: z.string(),
        params: z.record(z.string(), toolParameterValueSchema),
      }),
    ),
  }),
